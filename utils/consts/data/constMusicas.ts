...
const ENDPOINTS = {
    POST_ADICIONAR: 'api/Musicas/adicionar',
    GET_TODOS: 'api/Musicas/todos',
    GET_BY_ID: 'api/Musicas',
    GET_BY_PLAYLIST: 'api/Musicas/byPlaylistId',
    POST_ADICIONAR_MUSICA_EM_PLAYLSITS: 'api/Musicas/adicionarMusicaEmPlaylists'
};
...
const DEV = {
    ...
    API_URL_POST_ADICIONAR_MUSICA_EM_PLAYLSITS: `${API_BASE_URL_DEV}/${ENDPOINTS.POST_ADICIONAR_MUSICA_EM_PLAYLSITS}`
};
...
const PROD = {
    ...
    API_URL_POST_ADICIONAR_MUSICA_EM_PLAYLSITS: `${API_BASE_URL_PROD}/${ENDPOINTS.POST_ADICIONAR_MUSICA_EM_PLAYLSITS}`
};
