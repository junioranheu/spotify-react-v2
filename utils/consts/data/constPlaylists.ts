...
const ENDPOINTS = {
    ...
    POST_ATUALIZAR: 'api/Playlists/atualizar',
    GET_TODOS: 'api/Playlists/todos',
    GET_TODOS_NAO_ADM: 'api/Playlists/todosNaoAdm',
...
const DEV = {
    ...
    API_URL_GET_TODOS_NAO_ADM: `${API_BASE_URL_DEV}/${ENDPOINTS.GET_TODOS_NAO_ADM}`,
...
const PROD = {
    ...
    API_URL_GET_TODOS_NAO_ADM: `${API_BASE_URL_PROD}/${ENDPOINTS.GET_TODOS_NAO_ADM}`,
